...
class TestOrbAPIClient:
    ...
    @pytest.mark.asyncio
    async def test_get_dataset_json_format(self, sample_scores_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_get_dataset_jsonl_format(self, sample_jsonl_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_get_dataset_with_custom_caller_id(self, sample_scores_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_get_dataset_with_extra_params(self, sample_scores_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_get_responsiveness_1m(self, sample_responsiveness_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_get_responsiveness_1s(self, sample_responsiveness_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_get_responsiveness_15s(self, sample_responsiveness_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_get_web_responsiveness(self, sample_web_responsiveness_data, mock_httpx_response):
    ...
    async def test_get_all_datasets_basic(self, sample_all_datasets_response):
        ...
        with patch.object(OrbAPIClient, 'get_scores_1m', return_value=sample_all_datasets_response["scores_1m"]), \
             patch.object(OrbAPIClient, 'get_responsiveness', return_value=sample_all_datasets_response["responsiveness_1m"]), \
    ...
    @pytest.mark.asyncio
    async def test_get_all_datasets_with_all_responsiveness(self, sample_all_datasets_response):
    ...
    @pytest.mark.asyncio
    async def test_get_all_datasets_with_error(self, sample_all_datasets_response, sample_error_response):
        """Test get_all_datasets method with one dataset failing."""
        with patch.object(OrbAPIClient, 'get_scores_1m', return_value=sample_all_datasets_response["scores_1m"]), \
             patch.object(OrbAPIClient, 'get_responsiveness', side_effect=Exception("Connection error")), \
             patch.object(OrbAPIClient, 'get_web_responsiveness', return_value=sample_all_datasets_response["web_responsiveness"]), \
             patch.object(OrbAPIClient, 'get_speed_results', return_value=sample_all_datasets_response["speed_results"]):
    ...
    async def test_poll_dataset_success(self, sample_scores_data, mock_httpx_response):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            results = []
            async for records in client.poll_dataset("scores_1m", interval=0.01, max_iterations=2):
    ...
    @pytest.mark.asyncio
    async def test_poll_dataset_with_callback(self, sample_scores_data, mock_httpx_response):
    ...
    @pytest.mark.asyncio
    async def test_poll_dataset_with_async_callback(self, sample_scores_data, mock_httpx_response):
    ...
    async def test_poll_dataset_with_error(self, mock_httpx_response):
        ...
        mock_httpx_response.raise_for_status.side_effect = httpx.HTTPStatusError(
            "500 Internal Server Error", request=MagicMock(), response=mock_httpx_response
        )
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            results = []
            async for records in client.poll_dataset("scores_1m", interval=0.01, max_iterations=1):
                results.append(records)
    ...
    async def test_poll_dataset_infinite(self, sample_scores_data, mock_httpx_response):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            results = []
            count = 0
            async for records in client.poll_dataset("scores_1m", interval=0.01, max_iterations=None):
                results.append(records)
                count += 1
